...
**Podróżowanie i odpoczynek:** Do rozdysponowania dla drużyny jest 24 godziny dziennie. Przy czym dwa wydarzenia w ciągu dnia są obowiązkowe i ich niewykonanie skutkuje karą:

- Dwugodzinny odpoczynek w ciągu dnia - Jego brak skutkuje punktem zmęczenia. Ten punkt nie regeneruje się według standardowych zasad - a po prostu utrzymuje się do zakończenia spraw w bieżącym dniu podróży - nawet jeśli jakaś scena rozgrywa się w trakcie snu postaci.
- Wieczorny odpoczynek (10 godzin), na który składa się:
  - Budowa obozu. Jakość obozu określa się rzutami dopiero, gdy zaczyna mieć to znaczenie fabularne lub mechaniczne. Buduje / szuka dobrego miejsca jedna osoba, a pomagać mogą wszyscy pozostali. Przy czym, zaangażowane w budowę mogą być tylko te osoby, które nie wykonywały innych zadań, na przykład nie przygotowywały posiłku itp. - Obóz nie musi zostać zbudowany, jednak jego brak oznacza spanie pod gołym niebem. To z kolei może powodować konsekwencje w zależności od pogody lub zagrożeń w okolicy.
  - Wieczorny posiłek. To jest moment w którym odliczane są racje żywnościowe i woda. Jeśli drużyna je ciepły posiłek, niezbędny jest kucharz. Jednorazowy brak ciepłego posiłku, o ile nie jest wymagany ze względu na pogodę, nie powoduje negatywnych efektów. Jednak jeśli drużyna zaniedbuje ten aspekt, NPC zaczną narzekać i być może złościć. Natomiast gracze mogą w dość losowym momencie otrzymać czasową karę -1 do ducha spowodowane dziwnym rozdrażnieniem. Niekoniecznie wszyscy.
  - Sen. Większość ras potrzebuje 6 godzin snu. - Zrezygnowanie ze snu oznacza wchodzenie w mechanikę braku snu. Skrócenie czasu snu zamiast całkowitej rezygnacji może (wedle uznania MG) oznaczać łagodniejszy test.
  Wieczorny odpoczynek nie może zostać zamieniony na wędrówkę, za wyjątkiem szczególnych fabularnych sytuacji.

Pozostałe godziny, czyli 12 godzin i ewentualnie dodatkowe 2 w przypadku rezygnacji z odpoczynku w ciągu dnia - pozostają do dyspozycji graczy:
- Uzupełnianie zapasów. Chodzi oczywiście o wodę i żywność. Poszukiwać może każdy indywidualnie albo można sobie pomagać. Przy czym należy pamiętać, że ewentualna karawana zostawiona bez ochrony jest łakomym kąskiem dla każdego przechodnia o nieczystym sercu lub głodnej mutbestii. Poszukiwanie zapasów nie wymaga deklaracji czy to woda czy żywność. Poszukiwanie trwa godzinę i rozstrzyga się je testem Przetrwania z modyfikatorem -4. Za każdą dodatkowo przeznaczoną godzinę można złagodzić karę o 1. Czas musi być zadeklarowany przed rzutem, a już po nim, kolejne poszukiwanie to liczy się od nowa, czyli ponownie z modyfikatorem -4. MG określa jakość poszukiwań przy czym w przypadku żywności - do listy zapasów zostanie dopisane co zostało znalezione z podziałem na liczbę porcji liczących się jako racja żywnościowa. A w przypadku znalezienia wody, należy poświęcić dodatkową godzinę na napełnienie wszystkich pojemników - o ile postać, która znalazła wodę nie miała ich przy sobie. Dodatkowo - poszukiwanie zapasów obarczone jest ryzykiem. Bez względu na wynik - główny poszukiwacz (lub kilku jeśli każdy szukał osobno) rzuca kością losu. Szczęście w tym kontekście oznacza jedynie brak pecha. Wynik negatywny może oznaczać kłopoty - chociaż nie musi. Kłopoty mogą być różne - jedne bardziej inne mniej niebezpieczne. Czasem to dodatkowa strata czasu, czasem atak, a czasem jeszcze coś innego. Oczywiście w przypadku katastrofy podczas testu przetrwania - wynik na kości losu przestaje mieć znaczenie.
- Podróż. Tempo podróży jest zależne od terenu, obecności traktu, środku transportu, pogody, itd.
...
| Ludzie z cieniem |                     1                      |        2 litry        |                          6 h                           |
|     Mimetycy     |    1 (2 racje podczas regeneracji mocy)    |        2 litry        |                          6 h                           |
...
* Mimetycy podczas regeneracji mocy zjadają podwójną liczbę jedzenia
